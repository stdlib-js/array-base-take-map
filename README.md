...
```javascript
import takeMap from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-take-map@v0.1.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-base-take-map/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/array-base-take-map/actions/workflows/test.yml?query=branch:v0.1.2
